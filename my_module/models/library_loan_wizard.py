...
class LibraryLoanWizard(models.TransientModel):
    ...
    member_id = fields.Many2one('library.member', string='Member')  # record the member borrowing the books
    book_ids = fields.Many2many('library.book', string='Books')  # record the books being borrowed
